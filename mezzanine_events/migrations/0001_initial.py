# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-07-20 15:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.URLField(blank=True, help_text='Link to purchase tickets', verbose_name='External link')),
            ...
            bases=(models.Model, eventtools.models.OccurrenceMixin, mezzanine.utils.models.AdminThumbMixin),
        ),
        migrations.CreateModel(
            name='EventCategory',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='occurrences', to='mezzanine_events.Event')),
            ],
            options={
                'ordering': ('start', 'end'),
                'abstract': False,
        ...
        migrations.AddField(
            model_name='event',
            name='categories',
            field=models.ManyToManyField(blank=True, related_name='events', to='mezzanine_events.EventCategory', verbose_name='Categories'),
        ),
        migrations.AddField(
            model_name='event',
            name='related_events',
            field=models.ManyToManyField(blank=True, related_name='_event_related_events_+', to='mezzanine_events.Event', verbose_name='Related events'),
        ),
        migrations.AddField(
            model_name='event',
            name='site',
